...
export abstract class UnimplementedUserProtocolService {
    static definition = {
        SignIn: {
            path: "/UserProtocol/SignIn",
            requestStream: false,
...
export class UserProtocolClient extends grpc_1.makeGenericClientConstructor(UnimplementedUserProtocolService.definition, "UserProtocol", {}) {
